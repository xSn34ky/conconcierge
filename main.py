...
roles = ['Bronze', 'Bronze 2', 'Silver 1', 'PLATINUM', 'DIAMOND', 'CRIMSON', 'IRIDESCENT', 'TOP250']  # List of roles to display
...
bot.run('MTA4ODgyOTQ4MTE0NzQ0MTIwMg.G8GWv_.VuKsEyivY5rb2JTTIT1pjtmbJ-ej2iY8m4iYFI')
